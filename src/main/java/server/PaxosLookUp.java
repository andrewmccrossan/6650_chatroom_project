...
//            try {
//              BufferedReader otherPaxosServerReader = new BufferedReader(
//                      new InputStreamReader(newServerSocket.getInputStream()));
//              BufferedWriter otherPaxosServerWriter = new BufferedWriter(
//                      new OutputStreamWriter(newServerSocket.getOutputStream()));
//              if (paxosRole.equalsIgnoreCase("acceptor")) {
//                acceptorLookUpServersReadersWriters.put(otherPaxosServerReader, otherPaxosServerWriter);
//              } else if (paxosRole.equalsIgnoreCase("proposer")) {
//                proposerLookUpServersReadersWriters.put(otherPaxosServerReader, otherPaxosServerWriter);
//              } else { // learner
//                learnerLookUpServersReadersWriters.put(otherPaxosServerReader, otherPaxosServerWriter);
//              }
//            } catch (IOException e) {
//              e.printStackTrace();
//            }
